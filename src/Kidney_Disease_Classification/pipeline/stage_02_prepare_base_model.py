...
from Kidney_Disease_Classification.components.prepare_base_model import PrepareBaseMode
...
class PrepareBaseModeTrainingPipeline:
    ...
    def main(self):
        ...
        prepare_base_model = PrepareBaseMode(config=prepare_base_model_config)
